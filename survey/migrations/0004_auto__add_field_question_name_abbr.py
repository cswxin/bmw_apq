...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Question.name_abbr'
        db.add_column('survey_question', 'name_abbr', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Question.name_abbr'
        db.delete_column('survey_question', 'name_abbr')
