...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Alternative.multiple'
        db.add_column('survey_alternative', 'multiple', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Alternative.multiple'
        db.delete_column('survey_alternative', 'multiple')
