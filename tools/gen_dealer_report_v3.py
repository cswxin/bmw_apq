...
#生成dealer_report
def gen_dealer_report(project,term,term1,term2):
    if project.id == 1:
        source_file_name = u'doc/templates/APQ 2014 Wave III_templet_BMW_20140622.xls'
    if project.id == 2:
        source_file_name = u'doc/templates/APQ 2014 Wave III_templet_MINI_20140622.xls'
...
#        print dealer.name,dealer.dealertype.name_cn
        gen_report(term1,term2,dealer_naiton, dealer, source_file_name, target_file_name, report_nation, report_nation_t1, report_nation_t2, score_nation, project, term, report, report_max_nation)
        #pythoncom.CoUninitialize()
    return

@commit_on_success
def gen_report(term1,term2,dealer_naiton, dealer, source_file_name, target_file_name, report_nation, report_nation_t1, report_nation_t2, score_nation, project, term, report, report_max_nation):
...
#        #最终得分
        ...
        set_answers("D14", data_sheet5, score_dict_dealer.get('score'))
        set_answers("D15", data_sheet5, score_dict_region.get('score'))
        set_answers("D16", data_sheet5, score_dict_nation.get('score'))
        ...
        set_answers("D31", data_sheet5, score_dict_dealer.get('A'))
        set_answers("D37", data_sheet5, score_dict_dealer.get('B'))
        set_answers("D43", data_sheet5, score_dict_dealer.get('C'))
        set_answers("D49", data_sheet5, score_dict_dealer.get('D'))
        set_answers("D55", data_sheet5, score_dict_dealer.get('E'))
        set_answers("D61", data_sheet5, score_dict_dealer.get('G'))
...
if __name__ == "__main__":
    ...
    gen_dealer_report(project_bmw,term,term1,term2)
    print 'finish'
    
#    print 'generate mini report...'
#    project_mini = Project.objects.get(id=2)
#    gen_dealer_report(project_mini,term,term1,term2)
#    print 'finish'