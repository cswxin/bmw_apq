...
def excel2report(term, dtype):
    ...
    if dtype == 'bmw':
        xls_file_name = u'得分数据大表_Q3_with raw data_BMW_20141209_to 爱调研.xls'
        project = Project.objects.get(id=1)
        dealertype = DealerType.objects.get(name_cn='BMW')
    elif dtype == 'mini':
        xls_file_name = u'得分数据大表_20140929_with raw data_MINI-to 爱调研.xls'
