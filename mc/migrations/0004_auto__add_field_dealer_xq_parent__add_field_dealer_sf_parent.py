...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dealer.xq_parent'
        db.add_column('mc_dealer', 'xq_parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mymodel2_dealer', null=True, to=orm['mc.Dealer']), keep_default=False)

        # Adding field 'Dealer.sf_parent'
        db.add_column('mc_dealer', 'sf_parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mymodel3_dealer', null=True, to=orm['mc.Dealer']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Dealer.xq_parent'
        db.delete_column('mc_dealer', 'xq_parent_id')

        # Deleting field 'Dealer.sf_parent'
        db.delete_column('mc_dealer', 'sf_parent_id')
