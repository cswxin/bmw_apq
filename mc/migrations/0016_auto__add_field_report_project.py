...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('mc_report', 'project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Project'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Report.project'
        db.delete_column('mc_report', 'project_id')
