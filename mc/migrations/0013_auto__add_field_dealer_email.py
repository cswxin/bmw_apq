...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dealer.email'
        db.add_column('mc_dealer', 'email', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Dealer.email'
        db.delete_column('mc_dealer', 'email')
