...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Paper.visitor_num'
        db.add_column('mc_paper', 'visitor_num', self.gf('django.db.models.fields.IntegerField')(default=datetime.date(2012, 3, 5)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Paper.visitor_num'
        db.delete_column('mc_paper', 'visitor_num')
    ...
    models = {
        ...
        'mc.paper': {
            ...
            'visitor_num': ('django.db.models.fields.IntegerField', [], {})
        },
        'mc.paperaudit': {
