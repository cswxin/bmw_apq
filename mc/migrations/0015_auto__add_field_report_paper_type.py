...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.paper_type'
        db.add_column('mc_report', 'paper_type', self.gf('django.db.models.fields.CharField')(default='GFK', max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Report.paper_type'
        db.delete_column('mc_report', 'paper_type')
