...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dealer.level'
        db.add_column('mc_dealer', 'level', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Dealer.level'
        db.delete_column('mc_dealer', 'level')
