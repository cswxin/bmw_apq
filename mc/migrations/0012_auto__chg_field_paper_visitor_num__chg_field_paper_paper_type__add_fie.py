...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Paper.visitor_num'
        db.alter_column('mc_paper', 'visitor_num', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Paper.paper_type'
        db.alter_column('mc_paper', 'paper_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Adding field 'PaperDiff.final_paper'
        db.add_column('mc_paperdiff', 'final_paper', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='final', null=True, to=orm['mc.Paper']), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Paper.visitor_num'
        db.alter_column('mc_paper', 'visitor_num', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Paper.paper_type'
        db.alter_column('mc_paper', 'paper_type', self.gf('django.db.models.fields.CharField')(default='GFK', max_length=50))

        # Deleting field 'PaperDiff.final_paper'
        db.delete_column('mc_paperdiff', 'final_paper_id')
