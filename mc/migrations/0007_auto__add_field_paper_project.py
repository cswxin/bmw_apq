...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Paper.project'
        db.add_column('mc_paper', 'project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Project'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Paper.project'
        db.delete_column('mc_paper', 'project_id')
