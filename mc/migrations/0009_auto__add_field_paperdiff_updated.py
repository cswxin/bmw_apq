...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaperDiff.updated'
        db.add_column('mc_paperdiff', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2012, 2, 29), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PaperDiff.updated'
        db.delete_column('mc_paperdiff', 'updated')
