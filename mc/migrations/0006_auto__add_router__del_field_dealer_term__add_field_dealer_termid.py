...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Router'
        db.create_table('mc_router', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('term', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mc.Term'])),
            ('citys', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('mc', ['Router'])

        # Adding M2M table for field dealers on 'Term'
        db.create_table('mc_term_dealers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('term', models.ForeignKey(orm['mc.term'], null=False)),
            ('dealer', models.ForeignKey(orm['mc.dealer'], null=False))
        ))
        db.create_unique('mc_term_dealers', ['term_id', 'dealer_id'])

        # Deleting field 'Dealer.term'
        db.delete_column('mc_dealer', 'term_id')

        # Adding field 'Dealer.termid'
        db.add_column('mc_dealer', 'termid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('mc_router')

        # Removing M2M table for field dealers on 'Term'
        db.delete_table('mc_term_dealers')
        ...
        # Deleting field 'Dealer.termid'
        db.delete_column('mc_dealer', 'termid')
