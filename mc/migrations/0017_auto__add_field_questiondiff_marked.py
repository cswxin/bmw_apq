...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'QuestionDiff.marked'
        db.add_column('mc_questiondiff', 'marked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'QuestionDiff.marked'
        db.delete_column('mc_questiondiff', 'marked')
