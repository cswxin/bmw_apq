...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OtherReport'
        db.create_table('mc_otherreport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('visitor_num', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('newold', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('report_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('term', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mc.Term'])),
            ('dealertype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mc.DealerType'], null=True, blank=True)),
            ('dealer_num', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('max_score', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('min_score', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('ave_score', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
        ))
        db.send_create_signal('mc', ['OtherReport'])

        # Adding field 'Dealer.dt_parent'
        db.add_column('mc_dealer', 'dt_parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mymodel4_dealer', null=True, to=orm['mc.Dealer']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'OtherReport'
        db.delete_table('mc_otherreport')

        # Deleting field 'Dealer.dt_parent'
        db.delete_column('mc_dealer', 'dt_parent_id')
    ...
    models = {
        ...
        'mc.dealer': {
            ...
            'dt_parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'mymodel4_dealer'", 'null': 'True', 'to': "orm['mc.Dealer']"}),
        ...
        'mc.otherreport': {
            'Meta': {'object_name': 'OtherReport'},
            'ave_score': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'dealer_num': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'dealertype': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mc.DealerType']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_score': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'min_score': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'newold': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'visitor_num': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'})
        },
        'mc.paper': {
            ...
            'paper_type': ('django.db.models.fields.CharField', [], {'default': "'GFK'", 'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        'mc.paperdiff': {
            ...
            'bmw': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'fh_paper': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'p2'", 'to': "orm['mc.Paper']"}),
            'final_paper': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'final'", 'null': 'True', 'to': "orm['mc.Paper']"}),
        ...
        'mc.report': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'paper_type': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['survey.Project']", 'null': 'True', 'blank': 'True'}),
            'respondent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['survey.Respondent']", 'null': 'True', 'blank': 'True'}),
            'score': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'term': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mc.Term']", 'null': 'True', 'blank': 'True'}),
