...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'QuestionDiff'
        db.create_table('mc_questiondiff', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('paper_diff', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mc.PaperDiff'])),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Question'])),
            ('fw_q_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('fw_q_comment', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True, blank=True)),
            ('fh_q_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('fh_q_comment', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True, blank=True)),
            ('final_q_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('final_q_comment', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('mc', ['QuestionDiff'])

        # Adding model 'PaperDiff'
        db.create_table('mc_paperdiff', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fw_paper', self.gf('django.db.models.fields.related.ForeignKey')(related_name='p1', to=orm['mc.Paper'])),
            ('fh_paper', self.gf('django.db.models.fields.related.ForeignKey')(related_name='p2', to=orm['mc.Paper'])),
        ))
        db.send_create_signal('mc', ['PaperDiff'])

        # Adding field 'Router.user'
        db.add_column('mc_router', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'QuestionDiff'
        db.delete_table('mc_questiondiff')

        # Deleting model 'PaperDiff'
        db.delete_table('mc_paperdiff')

        # Deleting field 'Router.user'
        db.delete_column('mc_router', 'user_id')
