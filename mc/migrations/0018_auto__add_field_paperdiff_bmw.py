...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaperDiff.bmw'
        db.add_column('mc_paperdiff', 'bmw', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PaperDiff.bmw'
        db.delete_column('mc_paperdiff', 'bmw_id')
