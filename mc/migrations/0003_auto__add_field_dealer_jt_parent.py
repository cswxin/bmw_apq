...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dealer.jt_parent'
        db.add_column('mc_dealer', 'jt_parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mymodel_dealer', null=True, to=orm['mc.Dealer']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Dealer.jt_parent'
        db.delete_column('mc_dealer', 'jt_parent_id')
    ...
    models = {
        ...
        'mc.dealer': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jt_parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'mymodel_dealer'", 'null': 'True', 'to': "orm['mc.Dealer']"}),
