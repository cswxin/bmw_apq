...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaperDiff.status'
        db.add_column('mc_paperdiff', 'status', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PaperDiff.status'
        db.delete_column('mc_paperdiff', 'status')
